...
public class MovieDBResult implements Parcelable {
    ...
    protected MovieDBResult(Parcel in) {
    ...
    public static final Parcelable.Creator<MovieDBResult> CREATOR = new Parcelable.Creator<MovieDBResult>() {
        public MovieDBResult createFromParcel(Parcel source) {
            return new MovieDBResult(source);
        }
