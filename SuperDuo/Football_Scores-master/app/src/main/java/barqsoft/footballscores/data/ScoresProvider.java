...
public class ScoresProvider {
    ...
    @TableEndpoint(table = ScoresDatabase.SCORES) public static class Scores {
        ...
        // content://barqsoft.footballscores/scores/# [item]
        //
        ...
        public static Uri[] onInsert(ContentValues cv) {
            final long matchId = cv.getAsLong(ScoresColumns.MATCH_ID);
            return new Uri[] {
                    Scores.withId(matchId),
            };
        }
