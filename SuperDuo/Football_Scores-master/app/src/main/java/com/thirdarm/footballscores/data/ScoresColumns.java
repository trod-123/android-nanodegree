 ...
 *
 * Schematic implementation of table for fixture scores
 */
...
//    @DataType(TEXT) @NotNull String AWAY_NAME = "away_name";
    @DataType(TEXT) @References (table = ScoresDatabase.Tables.TEAMS, column = TeamsColumns.NAME)
        String HOME_NAME = "homeName";
    @DataType(TEXT) @References(table = ScoresDatabase.Tables.TEAMS, column = TeamsColumns.NAME)
        String AWAY_NAME = "awayName";
